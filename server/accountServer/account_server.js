/*************************
//账号服务器
1.和client交互，accountClientPort
2.和hall交互，hallIP,hallPort
*************************/
...
start = function(){
	let configs = require("./configs_win")
	config = configs.account_server()
	db.init(configs.mysql());
	hallAddr = config.hallIp  + ":" + config.hallAcountPort;
	app.listen(config.accountClientPort);
	console.log("account server is listening on " + config.accountClientPort);
}
